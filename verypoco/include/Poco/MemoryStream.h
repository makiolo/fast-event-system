...
class poco_API MemoryIOS: public virtual std::ios
...
class poco_API MemoryInputStream: public MemoryIOS, public std::istream
...
class poco_API MemoryOutputStream: public MemoryIOS, public std::ostream
	/// An input stream for reading from a memory area.
{
public:
