...
class poco_API StreamConverterBuf: public UnbufferedStreamBuf
...
class poco_API StreamConverterIOS: public virtual std::ios
...
class poco_API InputStreamConverter: public StreamConverterIOS, public std::istream
...
class poco_API OutputStreamConverter: public StreamConverterIOS, public std::ostream
