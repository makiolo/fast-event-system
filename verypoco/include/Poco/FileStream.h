...
class poco_API FileIOS: public virtual std::ios
...
class poco_API FileInputStream: public FileIOS, public std::istream
...
class poco_API FileOutputStream: public FileIOS, public std::ostream
...
class poco_API FileStream: public FileIOS, public std::iostream
