...
class poco_API PipeStreamBuf: public BufferedStreamBuf
...
class poco_API PipeIOS: public virtual std::ios
...
class poco_API PipeOutputStream: public PipeIOS, public std::ostream
...
class poco_API PipeInputStream: public PipeIOS, public std::istream
