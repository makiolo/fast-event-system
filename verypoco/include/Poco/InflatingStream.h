...
class poco_API InflatingStreamBuf: public BufferedStreamBuf
...
class poco_API InflatingIOS: public virtual std::ios
...
class poco_API InflatingOutputStream: public InflatingIOS, public std::ostream
...
class poco_API InflatingInputStream: public InflatingIOS, public std::istream
	/// This stream decompresses all data passing through it
	/// using zlib's inflate algorithm.
	/// Example:
