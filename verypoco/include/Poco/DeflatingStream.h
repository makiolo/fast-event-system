...
class poco_API DeflatingStreamBuf: public BufferedStreamBuf
...
class poco_API DeflatingIOS: public virtual std::ios
...
class poco_API DeflatingOutputStream: public DeflatingIOS, public std::ostream
...
class poco_API DeflatingInputStream: public DeflatingIOS, public std::istream
	/// This stream compresses all data passing through it
	/// using zlib's deflate algorithm.
{
public:
