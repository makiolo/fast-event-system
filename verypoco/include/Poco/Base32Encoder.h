...
class poco_API Base32EncoderBuf: public UnbufferedStreamBuf
...
class poco_API Base32EncoderIOS: public virtual std::ios
...
class poco_API Base32Encoder: public Base32EncoderIOS, public std::ostream
