...
class poco_API FIFOBufferStreamBuf: public BufferedBidirectionalStreamBuf
...
class poco_API FIFOIOS: public virtual std::ios
...
class poco_API FIFOBufferStream: public FIFOIOS, public std::iostream
