...
class poco_API Base64EncoderBuf: public UnbufferedStreamBuf
...
class poco_API Base64EncoderIOS: public virtual std::ios
...
class poco_API Base64Encoder: public Base64EncoderIOS, public std::ostream
