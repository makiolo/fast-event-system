...
class poco_API Base64DecoderBuf: public UnbufferedStreamBuf
...
class poco_API Base64DecoderIOS: public virtual std::ios
...
class poco_API Base64Decoder: public Base64DecoderIOS, public std::istream
