...
class poco_API NullStreamBuf: public UnbufferedStreamBuf
...
class poco_API NullIOS: public virtual std::ios
...
class poco_API NullInputStream: public NullIOS, public std::istream
...
class poco_API NullOutputStream: public NullIOS, public std::ostream
