...
class poco_API Base32DecoderBuf: public UnbufferedStreamBuf
...
class poco_API Base32DecoderIOS: public virtual std::ios
...
class poco_API Base32Decoder: public Base32DecoderIOS, public std::istream
