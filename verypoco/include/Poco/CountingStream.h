...
class poco_API CountingStreamBuf: public UnbufferedStreamBuf
...
class poco_API CountingIOS: public virtual std::ios
...
class poco_API CountingInputStream: public CountingIOS, public std::istream
...
class poco_API CountingOutputStream: public CountingIOS, public std::ostream
	/// This stream counts all characters and lines
	/// going through it.
{
public:
