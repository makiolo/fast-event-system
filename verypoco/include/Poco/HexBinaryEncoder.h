...
class poco_API HexBinaryEncoderBuf: public UnbufferedStreamBuf
...
class poco_API HexBinaryEncoderIOS: public virtual std::ios
...
class poco_API HexBinaryEncoder: public HexBinaryEncoderIOS, public std::ostream
