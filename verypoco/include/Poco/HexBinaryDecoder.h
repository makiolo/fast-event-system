...
class poco_API HexBinaryDecoderBuf: public UnbufferedStreamBuf
...
class poco_API HexBinaryDecoderIOS: public virtual std::ios
...
class poco_API HexBinaryDecoder: public HexBinaryDecoderIOS, public std::istream
