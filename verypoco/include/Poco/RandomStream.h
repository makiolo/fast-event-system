...
class poco_API RandomBuf: public BufferedStreamBuf
...
class poco_API RandomIOS: public virtual std::ios
...
class poco_API RandomInputStream: public RandomIOS, public std::istream
