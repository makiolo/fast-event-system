...
poco_API void floatToStr(char* buffer,
	int bufferSize,
	float value,
...
poco_API std::string& floatToStr(std::string& str,
	float value,
	int precision = -1,
	int width = 0,
	char thSep = 0,
...
poco_API void doubleToStr(char* buffer,
	int bufferSize,
	double value,
	int lowDec = -std::numeric_limits<double>::digits10,
	int highDec = std::numeric_limits<double>::digits10);
...
poco_API std::string& doubleToStr(std::string& str,
	double value,
	int precision = -1,
	int width = 0,
	char thSep = 0,
...
poco_API float strToFloat(const char* str);
...
poco_API bool strToFloat(const std::string&, float& result, char decSep = '.', char thSep = ',');
	/// Converts the string of characters into single-precision floating point number.
...
poco_API double strToDouble(const char* str);
	/// Converts the string of characters into double-precision floating point number.


poco_API bool strToDouble(const std::string& str, double& result, char decSep = '.', char thSep = ',');
	/// Converts the string of characters into double-precision floating point number.
	/// The conversion result is assigned to the result parameter.
	/// If decimal separator and/or thousand separator are different from defaults, they should be
	/// supplied to ensure proper conversion.
