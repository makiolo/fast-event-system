...
class poco_API LineEndingConverterStreamBuf: public UnbufferedStreamBuf
...
class poco_API LineEndingConverterIOS: public virtual std::ios
...
class poco_API InputLineEndingConverter: public LineEndingConverterIOS, public std::istream
...
class poco_API OutputLineEndingConverter: public LineEndingConverterIOS, public std::ostream
