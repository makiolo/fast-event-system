...
class poco_API TeeStreamBuf: public UnbufferedStreamBuf
...
class poco_API TeeIOS: public virtual std::ios
...
class poco_API TeeInputStream: public TeeIOS, public std::istream
...
class poco_API TeeOutputStream: public TeeIOS, public std::ostream
