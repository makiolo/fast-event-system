...
class poco_API DigestBuf: public BufferedStreamBuf
...
class poco_API DigestIOS: public virtual std::ios
...
class poco_API DigestInputStream: public DigestIOS, public std::istream
...
class poco_API DigestOutputStream: public DigestIOS, public std::ostream
